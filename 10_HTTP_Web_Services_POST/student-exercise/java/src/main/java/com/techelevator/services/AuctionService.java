...
public class AuctionService 
{
    ...
    public Auction add(String auctionString) 
    {
    	...
    	headers.setContentType(MediaType.APPLICATION_JSON);//data type to expect
    	
    	//body
    	HttpEntity<Auction> makeEntity = new HttpEntity<Auction>(newAuction, headers);
    ...
    public Auction update(String auctionString) 
    {
    	...
    	//append the ID as WHERE clause for the update statement
    	...
    	HttpEntity<Auction> makeEntity = new HttpEntity<Auction>(auctionToUpdate, headers);
    	
    	try
    	{
    		restTemplate.put(url, makeEntity);
    ...
    public boolean delete(int id) throws RestClientResponseException, ResourceAccessException 
    {
    	...
    	{
    		console.printError("No auction returned");
    	}
    	catch(ResourceAccessException ex)
    	{
    		console.printError("Network error occurred");
    	}
    	return false;
    }
